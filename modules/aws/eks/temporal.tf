locals {
  ...
  temporal_db_user          = var.temporal_db_username != "" ? var.temporal_db_username : local.eff_strings["db_username"]
  temporal_db_password      = var.temporal_db_password != "" ? var.temporal_db_password : local.eff_strings["db_password"]
  temporal_db_host          = aws_rds_cluster.postgres.endpoint
  temporal_sql_connect_addr = "${local.temporal_db_host}:${aws_rds_cluster.postgres.port}"
